...
const HotelDetails = () => {
  ...
  const handleBookRoom = (roomId, roomCapacity) => {
    navigate(
      `/booking/hotel/book/${roomId}?destination=${encodeURIComponent(destination)}&checkInDate=${checkInDate}&checkOutDate=${checkOutDate}&maxCapacity=${roomCapacity}`,
    );
  };
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <div className="mt-4">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            {room.amenities.map((amenity, index) => (
                              <div
                                key={index}
                                className="flex w-20 items-center gap-1 rounded-full bg-gray-100 px-2 py-1 text-xs"
                              >
                                {getAmenityIcon(amenity)}
                                <span>{amenity}</span>
                              </div>
                        ...
                        <div className="mt-6 flex items-center justify-between">
                          ...
                          <Button onClick={() => handleBookRoom(room.id, room.capacity)} variant="primary">
                            Book Now
                          </Button>
                        </div>
                      </div>
